...
VALUES 
	...
	('email3@gmail.com','Username3','Hoang Duc',3,1,'2018-07-17'),
    ...
    ('email9@gmail.com','Username10','Hoa Van',3,4,'2017-07-10'),
...
SELECT (SUBSTRING_INDEX(Content, ' ', 2)) = 'câu hỏi' FROM `Question`;
    ...
    WHERE  AccountID = 2;
	 ...
	 -- Question 15   
	UPDATE `Account`			
    SET AccountID = (SELECT * FROM `Account` WHERE AccountID = 5)
    WHERE AccountID = 4;    
    DELETE FROM `Account`	
    WHERE AccountID = 5;
